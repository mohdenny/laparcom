    ...
    return `
      <div class="wrapper">
        <div class="hero-image">
          <picture>
            <source media="(max-width: 600px)" srcset="hero-image-600.jpg">
            <source media="(max-width: 1000px)" srcset="hero-image-1000.jpg">
            <img class="gfg hero" src='hero-image-1200.jpg' alt="hero laparcom"></img>
          </picture>
